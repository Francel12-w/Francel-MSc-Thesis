...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Ppan1_CTP1 = [destination['A6']]
    Ppan2_CTP1 = [destination['B6']]
    Ppan3_CTP1 = [destination['C6']]
    Ppan4_CTP1 = [destination['D6']]
    Ppan5_CTP1 = [destination['E6']]
    Ppan6_CTP1 = [destination['F6']]



    # First adding CTP
    # Well1 - CTP1:
    p300.pick_up_tip(tips['D1'])
