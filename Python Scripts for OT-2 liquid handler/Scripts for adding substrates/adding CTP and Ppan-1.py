...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Ppan1_CTP1 = [destination['A2']]
    Ppan2_CTP1 = [destination['B2']]
    Ppan3_CTP1 = [destination['C2']]
    Ppan4_CTP1 = [destination['D2']]
    Ppan5_CTP1 = [destination['E2']]
    Ppan6_CTP1 = [destination['F2']]



    # First adding CTP
    # Well1 - CTP1:
    p300.pick_up_tip(tips['A7'])
