...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Ppan1_CTP1 = [destination['A10']]
    Ppan2_CTP1 = [destination['B10']]
    Ppan3_CTP1 = [destination['C10']]
    Ppan4_CTP1 = [destination['D10']]
    Ppan5_CTP1 = [destination['E10']]
    Ppan6_CTP1 = [destination['F10']]



    # First adding CTP
    # Well1 - CTP1:
    p300.pick_up_tip(tips['F5'])
