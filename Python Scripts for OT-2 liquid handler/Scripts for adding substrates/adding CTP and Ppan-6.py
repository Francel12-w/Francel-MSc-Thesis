...
def run(protocol: protocol_api.ProtocolContext):
    ...
    Ppan1_CTP1 = [destination['A12']]
    Ppan2_CTP1 = [destination['B12']]
    Ppan3_CTP1 = [destination['C12']]
    Ppan4_CTP1 = [destination['D12']]
    Ppan5_CTP1 = [destination['E12']]
    Ppan6_CTP1 = [destination['F12']]
    CTP_for_Blank = [destination['G12']]



    # First adding CTP
    # Well1 - CTP1:
    p300.pick_up_tip(tips['G7'])
